...
const PaginationLink = ({ className, isActive, ...props }: PaginationLinkProps) => (
  <a
    ...
    className={cn(
      "flex h-10 w-10 items-center justify-center rounded-md border bg-background p-0 text-sm ring-offset-background transition-colors hover:bg-accent hover:text-accent-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
